// /Users/zukonkonjane/Verista/frontend/src/components/common/Footer.jsx
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="text-xl font-bold text-white flex items-center mb-6">
              {/* Logo icon */}
            ...
            <p className="text-gray-400 mb-6">
              Transforming school transportation with real-time tracking, safety compliance, and peace of mind for parents across South Africa.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+27 81 234 5678</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">info@verista.co.za</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© 2025 Verista. All rights reserved.</p>
          <div className="flex justify-center space-x-4 mt-4">
            ...
            <Link to="/legal" className="text-gray-400 hover:text-white text-sm transition">Legal</Link>
          </div>
        </div>
      </div>
    </footer>
